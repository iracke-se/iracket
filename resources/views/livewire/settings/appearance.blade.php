<div class="max-w-2xl mx-auto">
    ...
    <x-settings.layout :heading="__('user-settings.appearance_heading')" :subheading="__('user-settings.appearance_subheading')">
        <div class="flex gap-3">
            ...
            >
                ...
                <span class="text-sm font-medium">{{ __('user-settings.light') }}</span>
            </button>
            ...
            >
                ...
                <span class="text-sm font-medium">{{ __('user-settings.dark') }}</span>
            </button>
            ...
            >
                ...
                <span class="text-sm font-medium">{{ __('user-settings.system') }}</span>
            </button>
        </div>
    </x-settings.layout>
