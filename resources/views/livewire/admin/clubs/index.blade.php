<div class="max-w-6xl mx-auto py-6 px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-zinc-800 rounded-xl p-4 border border-zinc-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-white mt-1">{{ $totalClubs }}</p>
                </div>
        ...
        <div class="bg-zinc-800 rounded-xl p-4 border border-zinc-700">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-zinc-400">{{ __('Total Members') }}</p>
        ...
        <div class="bg-zinc-800 rounded-xl p-4 border border-zinc-700">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-zinc-400">{{ __('With Members') }}</p>
                    <p class="text-2xl font-bold text-white mt-1">{{ $clubsWithMembers }}</p>
                </div>
        ...
        <div class="bg-zinc-800 rounded-xl p-4 border border-zinc-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-white mt-1">{{ $clubsThisMonth }}</p>
                </div>
    ...
    <div class="flex gap-4 mb-6">
        ...
        >
            ...
            <option value="1">{{ __('With Members') }}</option>
            <option value="0">{{ __('No Members') }}</option>
        </select>
    </div>
                ...
                @forelse($clubs as $club)
                    <tr class="hover:bg-zinc-700/30">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right">
                            <a href="{{ route('clubs.show', $club) }}" class="text-blue-400 hover:text-blue-300 mr-3" wire:navigate>{{ __('View') }}</a>
