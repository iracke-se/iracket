    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-zinc-800 rounded-xl p-4 border border-zinc-700">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-zinc-400">{{ __('Total Terms') }}</p>
                    <p class="text-2xl font-bold text-white mt-1">{{ $totalTerms }}</p>
                </div>
        ...
        <div class="bg-zinc-800 rounded-xl p-4 border border-zinc-700">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-zinc-400">{{ __('Active') }}</p>
                    <p class="text-2xl font-bold text-white mt-1">{{ $activeTerms }}</p>
                </div>
        ...
        <div class="bg-zinc-800 rounded-xl p-4 border border-zinc-700">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-zinc-400">{{ __('Inactive') }}</p>
                    <p class="text-2xl font-bold text-white mt-1">{{ $inactiveTerms }}</p>
                </div>
