<x-errors.layout>
    <div class="max-w-md">
        <p class="text-8xl font-bold text-accent">419</p>
        <h1 class="mt-4 text-2xl font-semibold text-zinc-900 dark:text-white">{{ __('Page expired') }}</h1>
        <p class="mt-2 text-zinc-500 dark:text-zinc-400">{{ __('Your session has expired. Please refresh and try again.') }}</p>
