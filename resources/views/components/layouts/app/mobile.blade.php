    ...
    <body class="min-h-screen bg-white dark:bg-zinc-900">
        ...
        <header class="fixed top-0 left-0 right-0 z-50 bg-zinc-900 border-b border-zinc-800">
            <div class="flex items-center justify-between px-4 h-14">
                ...
                <!-- Logo and Title -->
                <a href="{{ route('players') }}" class="flex items-center gap-2" wire:navigate>
        ...
        <nav class="fixed bottom-0 left-0 right-0 z-50 bg-zinc-900 border-t border-zinc-800">
            <div class="flex items-center justify-around h-16">
                <!-- Players -->
                <a href="{{ route('players') }}" class="flex flex-col items-center justify-center gap-1 px-3 py-2 {{ request()->routeIs('players') ? 'text-accent' : 'text-zinc-400 hover:text-white' }} transition-colors" wire:navigate>
                ...
                <!-- Bubbler -->
                <a href="#" class="flex flex-col items-center justify-center gap-1 px-3 py-2 text-zinc-400 hover:text-white transition-colors" wire:navigate>
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
