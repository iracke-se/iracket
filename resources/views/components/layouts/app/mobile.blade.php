    ...
    <body class="min-h-screen bg-white dark:bg-zinc-900">
        ...
        <nav class="fixed bottom-0 left-0 right-0 z-50 bg-zinc-900 border-t border-zinc-800">
            <div class="flex items-center justify-around h-16">
                <!-- Players -->
                <a href="{{ route('dashboard') }}" class="flex flex-col items-center justify-center gap-1 px-3 py-2 {{ request()->routeIs('dashboard') ? 'text-accent' : 'text-zinc-400 hover:text-white' }} transition-colors" wire:navigate>
