        ...
        <div class="flex">
            ...
            <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-zinc-800 border-r border-zinc-700">
                ...
                <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-zinc-700">
                    <a href="{{ route('players') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-zinc-400 hover:text-white hover:bg-zinc-700 transition-colors" wire:navigate>
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
